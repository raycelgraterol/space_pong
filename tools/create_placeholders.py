...
def create_star_tile(size, filename):
    ...
    surface.fill((10, 10, 25))  # Espacio oscuro
...
def create_laser_grid(width, height, filename):
    ...
    # Segmentos para efecto de "malla"
...
def main():
    ...
    # Inicializar pygame para poder crear surfaces
    pygame.init()
